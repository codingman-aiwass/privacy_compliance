...
def handle_dep(dep_result: List[dict]) -> List[dict]:
    ...
    for i in range(len(dep_result)):
        ...
        if dep_item['deprel'] == 'dep' and dep_item['head'] == tmp_condition_item['id'] and dep_item['upos'] == 'NN' or dep_item['deprel'] == 'conj' and dep_item['head'] == tmp_condition_item['id'] and dep_item['upos'] == 'NN':
    ...
    for i in range(len(dep_result)):
        ...
        if dep_item['deprel'] == 'nn' and dep_item['head'] in conjunction_id_to_item_dict.keys():
            ...
            conjunction_id_to_item_dict[dep_item['head']]['form'] = dep_item['form'] + conjunction_id_to_item_dict[dep_item['head']]['form']
